        ...
        <div className="w-full max-w-sm space-y-6">
          <Card className="border-border/60 bg-card/50 backdrop-blur-md rounded-2xl overflow-hidden shadow-2xl shadow-black/20">
            <CardHeader className="space-y-1 pb-4">
              <CardTitle className="text-2xl font-bold tracking-tight text-white lowercase">sign in</CardTitle>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="password" className="text-xs font-semibold text-foreground/60 uppercase tracking-widest">Password</Label>
                    <Link href="#" className="text-[10px] uppercase font-bold text-accent hover:underline">Forgot password?</Link>
                  </div>
                  <Input
                    id="password"
                    type="password"
